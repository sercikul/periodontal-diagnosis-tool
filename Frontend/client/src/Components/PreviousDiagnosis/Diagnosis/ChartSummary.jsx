                ...
                <ImplantsDiagnosisContainer style={this.props.printable === 1 ? ({ border: 'none', borderRadius: 'none', boxShadow: 'none', padding: 'none', marginTop: '-15%'}) : null}>
                    <Header style={this.props.printable === 1 ? ({ fontSize: '24px'}) : null}>Chart Summary</Header>
                        <StyledGrid container spacing={1} direction="row" justify="space-between" style={{ flex: 1 }}>
                            ...
                            <Grid>
                                <FormLabel style={ {fontSize: '16px'} }>{localStorage.getItem("PlagueScore") + " %"}</FormLabel>
                            </Grid>
                        </StyledGrid>
                        <StyledGrid container spacing={1} direction="row" justify="space-between" style={{ flex: 1 }}>
                            <Grid item xs={4} >
                            ...
                            <Grid>
                                <FormLabel style={ {fontSize: '16px'} }>{localStorage.getItem("DSScore") + " %"}</FormLabel>
                            </Grid>
                        </StyledGrid>
                        <StyledGrid container spacing={1} direction="row" justify="space-between" style={{ flex: 1 }}>
                            <Grid item xs={4} >
                            ...
                            <Grid>
                                <FormLabel style={ {fontSize: '16px'} }>{localStorage.getItem("BoPScore") + " %"}</FormLabel>
                            </Grid>
                        </StyledGrid>
