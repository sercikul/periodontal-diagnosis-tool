...
//makeStyles to assign CSS to certain table elements
...
export default function CustomizedTables(props) {
  //Specify, if chart is printable or not
  const { printableVersion } = props;
  const classes = useStyles();

  //Initialise Data using React Hooks
  ...
  //Pocket Attachment visualisation
  ...
  //First Half: Call line functions for each tooth
  ...
  //Session Storage with useEffect, enables data to persist on refresh
  useEffect(() => {
    const data18 = JSON.parse(sessionStorage.getItem("18"));
    const data17 = JSON.parse(sessionStorage.getItem("17"));
    const data16 = JSON.parse(sessionStorage.getItem("16"));
    const data15 = JSON.parse(sessionStorage.getItem("15"));
    const data14 = JSON.parse(sessionStorage.getItem("14"));
    const data13 = JSON.parse(sessionStorage.getItem("13"));
    const data12 = JSON.parse(sessionStorage.getItem("12"));
    const data11 = JSON.parse(sessionStorage.getItem("11"));
    const data21 = JSON.parse(sessionStorage.getItem("21"));
    const data22 = JSON.parse(sessionStorage.getItem("22"));
    const data23 = JSON.parse(sessionStorage.getItem("23"));
    const data24 = JSON.parse(sessionStorage.getItem("24"));
    const data25 = JSON.parse(sessionStorage.getItem("25"));
    const data26 = JSON.parse(sessionStorage.getItem("26"));
    const data27 = JSON.parse(sessionStorage.getItem("27"));
    const data28 = JSON.parse(sessionStorage.getItem("28"));
  ...
  //Store Tooth Objects in Session Storage
  useEffect(() => {
    sessionStorage.setItem("18", JSON.stringify(tooth18));
    sessionStorage.setItem("17", JSON.stringify(tooth17));
    sessionStorage.setItem("16", JSON.stringify(tooth16));
    sessionStorage.setItem("15", JSON.stringify(tooth15));
    sessionStorage.setItem("14", JSON.stringify(tooth14));
    sessionStorage.setItem("13", JSON.stringify(tooth13));
    sessionStorage.setItem("12", JSON.stringify(tooth12));
    sessionStorage.setItem("11", JSON.stringify(tooth11));
    sessionStorage.setItem("21", JSON.stringify(tooth21));
    sessionStorage.setItem("22", JSON.stringify(tooth22));
    sessionStorage.setItem("23", JSON.stringify(tooth23));
    sessionStorage.setItem("24", JSON.stringify(tooth24));
    sessionStorage.setItem("25", JSON.stringify(tooth25));
    sessionStorage.setItem("26", JSON.stringify(tooth26));
    sessionStorage.setItem("27", JSON.stringify(tooth27));
    sessionStorage.setItem("28", JSON.stringify(tooth28));
  });
...
//Get data; Chart Input constraints
...
//Probe Limit
  ...
  return (
    ...
    <div className="group_vertical">
      ...
      <SubHeader className={sessionStorage.getItem("messageForChart") ? null: classes.disable_furcation}>* There is no need to complete the entire chart, please only do the implant screening. </SubHeader>
      {printableVersion === 1 ? null:<HelpButton onClick={()=>{setVideo(!video)}}>Help</HelpButton>}
    <div className="group">
    ...
    <ChartLower printableVersion={printableVersion} dataBoP1={totBoP} dataPlague1={totPlague} 
      dataDS1={deepSides()} lock18={Lock.t18} lock17={Lock.t17} lock16={Lock.t16} 
      lock15={Lock.t15} lock14={Lock.t14} lock13={Lock.t13} lock12={Lock.t12} lock11={Lock.t11}
     lock28={Lock.t28} lock27={Lock.t27} lock26={Lock.t26} lock25={Lock.t25} lock24={Lock.t24} 
      lock23={Lock.t23} lock22={Lock.t22} lock21={Lock.t21}/>
    </div>
    {printableVersion === 1 ? null:<ChartButtons/> }

    {printableVersion !== 1 && <>
      {video && <>
        <YoutubeEmbed close={()=>{setVideo(false);}}/>
      </>}
    </>}
