...
class PatientSummary extends React.Component{
    constructor(props){
        ...
        this.state = {
            patientFirstName: sessionStorage.getItem("firstName"),
            patientLastName: sessionStorage.getItem("lastName"),
            patientDateOfBirth: sessionStorage.getItem("dobDate"),
            patientMrnCode: sessionStorage.getItem('mrnCode'),
            patientHealthStatusSelected: sessionStorage.getItem('healthStatusSelected'),
            patientSmokingCigarettes: sessionStorage.getItem('smokingCigarettes'),
            patientDegreeOfDiabetes: sessionStorage.getItem('DegreeOfDiabetes'),
            patientHealthStatusDetails: sessionStorage.getItem('HealthStatusDetails'),
            implantStatus: sessionStorage.getItem("ImplantStatusDropItems"),
    ...
    render(){
        if (this.state.patientDateOfBirth !== "Not Provided"){
            ...
            sessionStorage.setItem("patientDateOfBirth", "Not Provided");
        }
        return (
            <>
