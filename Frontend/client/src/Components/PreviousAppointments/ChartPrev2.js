...
//Session Storage for all the teeth
  ...
  useEffect(() => {
    const data48 = JSON.parse(localStorage.getItem("48"));
    const data47 = JSON.parse(localStorage.getItem("47"));
    const data46 = JSON.parse(localStorage.getItem("46"));
    const data45 = JSON.parse(localStorage.getItem("45"));
    const data44 = JSON.parse(localStorage.getItem("44"));
    const data43 = JSON.parse(localStorage.getItem("43"));
    const data42 = JSON.parse(localStorage.getItem("42"));
    const data41 = JSON.parse(localStorage.getItem("41"));
    const data31 = JSON.parse(localStorage.getItem("31"));
    const data32 = JSON.parse(localStorage.getItem("32"));
    const data33 = JSON.parse(localStorage.getItem("33"));
    const data34 = JSON.parse(localStorage.getItem("34"));
    const data35 = JSON.parse(localStorage.getItem("35"));
    const data36 = JSON.parse(localStorage.getItem("36"));
    const data37 = JSON.parse(localStorage.getItem("37"));
    const data38 = JSON.parse(localStorage.getItem("38"));
  ...
  //Calculate Scores
  const dataBoP2 = BoP.BoP_total_41 + BoP.BoP_total_42 + BoP.BoP_total_43 + BoP.BoP_total_44 + BoP.BoP_total_45 + BoP.BoP_total_46 + BoP.BoP_total_47 + BoP.BoP_total_48 + BoP.BoP_total_31 + BoP.BoP_total_32 + BoP.BoP_total_33 + BoP.BoP_total_34 + BoP.BoP_total_35 + BoP.BoP_total_36 + BoP.BoP_total_37 + BoP.BoP_total_38;
  const dataPlague2 = Plague.Plague_total_41 + Plague.Plague_total_42 + Plague.Plague_total_43 + Plague.Plague_total_44 + Plague.Plague_total_45 + Plague.Plague_total_46 + Plague.Plague_total_47 + Plague.Plague_total_48 + Plague.Plague_total_31 + Plague.Plague_total_32 + Plague.Plague_total_33 + Plague.Plague_total_34 + Plague.Plague_total_35 + Plague.Plague_total_36 + Plague.Plague_total_37 + Plague.Plague_total_38;
  ...
  return (
    ...
    <div className="progress-container">
      {oralData.map((item, idx) => (
        <ProgressBar variable={item.variable} key={idx} bgcolor={item.bgcolor} completed={item.completed} subtitle={item.subtitle}/>
      ))}
    </div>}
    </div>
    </div>
